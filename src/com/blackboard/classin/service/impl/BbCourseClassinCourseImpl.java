...
public class BbCourseClassinCourseImpl implements IBbCourseClassinCourse{
	...
	public void deleteClassInCourseStudent() throws JsonParseException, JsonMappingException, IOException {
		String classin_getcoursestudent_url = "https://www.eeo.cn/partner/api/course.api.php?action=getCourseStudent";
		String classin_deletecoursestudent_url = "https://www.eeo.cn/partner/api/course.api.php?action=delCourseStudent";
				    	...
				    	data.forEach((telephone,userId)->{
				    		...
				    		if(user == null) {
					    		...
					    		sb.append(param1)
						        	...
						        	.append("&studentAccount="+telephone);
